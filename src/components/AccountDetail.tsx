        ...
        <div className="bg-card border border-border rounded-xl p-5 animate-fade-in-up stagger-6 card-hover">
          ...
          <ResponsiveContainer width="100%" height={260}>
            <AreaChart data={cumData}>
              ...
              <Tooltip contentStyle={{ backgroundColor: "hsl(var(--card))", border: "1px solid hsl(var(--border))", borderRadius: 10, fontSize: 12, boxShadow: "0 4px 12px rgba(0,0,0,0.1)" }} formatter={(v: number | undefined) => [fmtEur(v ?? 0)]} />
